...
#ifndef GOOGLE_PROTOBUF_INCLUDED_simple_5fudp_5fsend_5freceive_2faddressbook_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_simple_5fudp_5fsend_5freceive_2faddressbook_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_simple_5fudp_5fsend_5freceive_2faddressbook_2eproto
...
struct TableStruct_simple_5fudp_5fsend_5freceive_2faddressbook_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_simple_5fudp_5fsend_5freceive_2faddressbook_2eproto;
namespace tutorial {
class AddressBook;
...
inline const std::string& Person_PhoneType_Name(Person_PhoneType value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum
    <Person_PhoneType_descriptor, 0, 2>(static_cast<int>(value));
}
inline bool Person_PhoneType_Parse(
    ::absl::string_view name, Person_PhoneType* value) {
...
class Person_PhoneNumber final :
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_simple_5fudp_5fsend_5freceive_2faddressbook_2eproto;
};// -------------------------------------------------------------------
...
class Person final :
 ...
 public:
  ...
  static inline bool PhoneType_Parse(::absl::string_view name,
      PhoneType* value) {
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_simple_5fudp_5fsend_5freceive_2faddressbook_2eproto_2epb_2eh
